...
Logger.info("\u001B[1m\u001B[32mMultiOgar-Edited " + gameServer.version + "\u001B[37m - An open source multi-protocol ogar server \u001B[36m[Agarmen edited "+gameServer.agarmenversion+"]\u001B[0m");

var fin = "\u001B[35mKey, Bomb, Exlode, Froze systems: ";
const enable = "\u001B[32mEnabled", disable = "\u001B[31mDisabled";
if(gameServer.config.enableKBEF)
	fin = fin + enable;
else
	fin = fin + disable;
Logger.info(fin);
...
figlet(('Agarmen.com ' + gameServer.agarmenversion), function(err, data) {
    if (err) {
